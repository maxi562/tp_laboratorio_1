...
int tomarDatos(char* array,int limite,char* mensaje)
{
    char buffer[4098];
    int lenBuffer;
    int i;
    ...
    primeraMayuscula(buffer);
    strcpy(array,buffer);

    return retorno;
}

void primeraMayuscula(char* array)
{
    int i;
    int lenArray;
    char buffer[4098];

    lenArray = strlen(array);
    strcpy(buffer,array);
